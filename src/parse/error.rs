...
impl ParseError {
	pub fn extra_tokens(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::ExtraTokens(t) };
	}

	pub fn unexpected_eof(token_idx: usize) -> Self {
		return Self { token_idx, kind: ParseErrorKind::UnexpectedEof };
	}

	pub fn bad_expression(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::BadExpression(t) };
	}

	pub fn bad_statement(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::BadStatement(t) };
	}

	pub fn expected_token(token_idx: usize, exp: TokenKind, act: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::ExpectedToken { exp, act } };
	}

	pub fn expected_name(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::ExpectedName(t) };
	}

	pub fn expected_decl(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::ExpectedDecl(t) };
	}

	pub fn expected_type(token_idx: usize, t: TokenKind) -> Self {
		return Self { token_idx, kind: ParseErrorKind::ExpectedType(t) };
	}

	pub fn no_return(token_idx: usize, name: String) -> Self {
		return Self { token_idx, kind: ParseErrorKind::NoReturn(name) };
	}
